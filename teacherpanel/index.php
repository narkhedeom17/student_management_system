...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($result->num_rows === 1) {
        ...
        $dob_clean = str_replace("-", "", $staff['dob']); // Convert DOB to YYYYMMDD

        if ($password_input === $dob_clean) {
            $_SESSION['teacher_loggedin'] = true;
            $_SESSION['staff_no'] = $staff['staff_no'];
            $_SESSION['staff_name'] = $staff['name']; // Use single 'name' column
            header("Location: dashboard.php");
            exit();
        } else {
...
<head>
  ...
  <title>Teacher Login | Newton House School</title>
  <style>
    body {
      margin: 0;
      padding: 0;
...
<div class="left-panel">
  ...
  <p>Access your profile, student records, and manage data here.<br>Login using your staff number and birthdate.</p>
  <img src="images/newtons.png" alt="Newton School Logo" class="bottom-image">
</div>
...
<div class="right-panel">
  <div class="login-box">
    ...
    <form method="post">
      <label for="staff_no">Username</label>
